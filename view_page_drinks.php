...
<section class="quick-view">
    ...
    <?php  
        if(isset($_GET['pid'])){
            $pid = $_GET['pid'];
            $select_drinks = mysqli_query($conn, "SELECT * FROM `drinks` where id_drinks = '$pid'") or die('query failed');
    ...
    <form action="" method="POST" class="box">
         ...
         <input type="submit" value="Tambah Ke Wishlist" name="add_drink_to_wishlist" class="option-btn">
