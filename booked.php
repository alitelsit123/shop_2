...
<section class="heading">
    ...
    <p> <a href="home.php">home</a> / Reservation </p>
</section>

<section class="placed-orders">

    <h1 class="title">Meja Anda</h1>

    <div class="box-container">

    <?php
        $select_orders = mysqli_query($conn, "SELECT * FROM `booked` WHERE user_id = '$user_id'") or die('query failed');
